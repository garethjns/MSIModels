...
class MultisensoryBase(KerasSKBase):
    ...
    def _build_intermediate_channel(self, input_layer: layers.Layer,
        ...
        side_max_pool_2 = layers.MaxPooling1D(pool_size=self.max_pool_2, name=f"{side}_max_pool_2")(side_conv_2)
    ...
    def _build_late_channel(self, input_layer: layers.Layer,
        ...
        fc_1 = layers.Dense(int(self.fc_1_units_input_prop * self.input_length),
                            activation=self.fc_1_activation, name=f"{side}_fc_1")(input_layer)
