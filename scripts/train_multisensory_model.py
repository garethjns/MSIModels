...
if __name__ == "__main__":
    limit_gpu_memory(4000)

    # Specify a dataset previously generated by scripts/mixed_type_multisensory_data.py
    path = 'data/scripts_multisensory_data_mix.hdf5'
    if not os.path.exists(path):
        raise RuntimeWarning(f"Need to generate data first - run scripts/generate_mixed_type_multisensory_data.py")
