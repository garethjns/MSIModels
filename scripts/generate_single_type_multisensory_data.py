...
if __name__ == "__main__":
    ...
    fn = 'data/sample_multisensory_data_matched_sync_hard_250k.hdf5'
    if not os.path.exists(fn):
        MultiTwoGapStim.generate(templates=[MultiTwoGapTemplate['matched_sync']],
                                 fs=500,
                                 n=N,
                                 ...
                                 template_kwargs={"duration": 1300,
                                                  "background_mag": DIFFICULTY,
                                                  "duration_tol": 0.5})

    fn = 'data/sample_multisensory_data_matched_async_hard_250k.hdf5'
    if not os.path.exists(fn):
    ...
    if not os.path.exists(fn):
        MultiTwoGapStim.generate(templates=[MultiTwoGapTemplate['unmatched_async']],
                                 fs=500,
                                 n=N,
                                 batch_size=BATCH_SIZE,
                                 fn=fn,
